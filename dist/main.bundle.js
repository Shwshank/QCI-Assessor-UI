...
var APIService = (function () {
    ...
    APIService.prototype.SendSubmitResponseID = function (id) {
        var headers = new __WEBPACK_IMPORTED_MODULE_0__angular_http__["a" /* Headers */]();
        this.createAuthorizationHeader(headers);
...
var ProjectService = (function () {
    ...
    ProjectService.prototype.sendSubmitOfflineResponseID5 = function (res) {
        var _this = this;
        console.log(res);
        this.apiService.SendSubmitResponseID(res.response.ResCid).subscribe(function (res2) {
            // console.log(res2);
            if (res2.success) {
    ...
    ProjectService.prototype.sendSubmitResponseID = function (response, id) {
        var _this = this;
        console.log(response);
        this.apiService.SendSubmitResponseID(id).subscribe(function (res) {
            // console.log(res);
            if (res.success) {
