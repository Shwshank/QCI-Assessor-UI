...
var InputLocationComponent = (function () {
    ...
    InputLocationComponent.prototype.refreshLocation = function () {
        ...
        navigator.geolocation.getCurrentPosition(function (res) {
            ...
            _this.json.value = { lat: _this.lat, lng: _this.lng, acc: _this.accuracy };
            _this.responseData.emit(_this.json);
        }, function (err) {
            console.log(err);
        }, {
...
var ProjectService = (function () {
    function ProjectService(apiService, router) {
        ...
        this.emitForm_sync = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["x" /* EventEmitter */]();
                    ...
                    var sub1 = _this.apiService.SubmitResponse(response[i].response).subscribe(function (res) {
                        ...
                        if (res.success) {
                            ...
                            _this.db.delete('asrResponse', response[i].id).then(function () {
                                navigator.vibrate(_this.vibrateDuration0);
            ...
            this.apiService.GetFormArray(form_token).subscribe(function (res) {
                ...
                if (res) {
                    ...
                    if (res.form_token != localStorage.getItem('form_token')) {
                        // token dosen't match
                        navigator.vibrate(_this.vibrateDuration1);
                        localStorage.setItem('form_token', res.form_token);
