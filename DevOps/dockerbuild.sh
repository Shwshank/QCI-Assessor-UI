...
mv /var/lib/jenkins/workspace/collect-assesor-frontend-pipeline/QCI-Assessor-UI/dist /var/lib/jenkins/workspace/collect-assesor-frontend/
rm -rf $REPONAME
